          ...
          {continueLearning.length > 0 && (
            ...
            >
              ...
              <View style={styles.heroCardMid}>
                <Text style={styles.heroCardLabel}>CONTINUE LEARNING</Text>
                <Text style={styles.heroCardTitle}>{continueLearning[0].title}</Text>
                <Text style={styles.heroCardSub}>{continueLearning[0].progressPercent}% complete</Text>
              </View>
